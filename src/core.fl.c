...
"    var result = 0\n"
"    each element in this\n"
"      if function(element) do result => + 1\n"
"    return result\n"
"\n"
"  forEach(function)\n"
"    each element in this\n"
...
"      for var count = this.count; count > 0 and iterator; count => - 1\n"
"        iterator = this.sequence.iterate(iterator)\n"
"      return iterator\n"
"\n"
...
"      result => + this[last..<index] + to\n"
"      last = index + fromSize\n"
"\n"
"    if last < size do result => + this[last..-1]\n"
"\n"
"    return result\n"
"\n"
"  trim() = this.trim_(\"\\t\\r\\n \", True, True)\n"
